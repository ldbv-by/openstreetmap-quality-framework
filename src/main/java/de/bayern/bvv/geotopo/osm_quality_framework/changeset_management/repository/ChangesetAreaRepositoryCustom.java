...
import de.bayern.bvv.geotopo.osm_quality_framework.changeset_management.entity.AreaEntity;
...
public interface ChangesetAreaRepositoryCustom {
    List<AreaEntity> fetchByFeatureFilter(Long changesetId, OsmIds osmIds, Criteria criteria);
}
