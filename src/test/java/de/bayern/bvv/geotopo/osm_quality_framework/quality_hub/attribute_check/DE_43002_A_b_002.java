...
/**
 * AdV-Beschreibung:
 * Wenn bei der Attributart 'nutzung' die Werteart 3000 Waldbestattungsfläche belegt ist,
 * muss auch die Attributart 'Name' belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_43002_A_b_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.43002.A.b.002"));
    ...
    @Test
    void createWaldbestattungsflaecheMitNamen() throws Exception {
        // Arrange
    ...
    @Test
    void createWaldbestattungsflaecheOhneNamen() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'name' muss belegt sein, wenn das Tag 'nutzung' den Wert 3000 hat.");
    }
}