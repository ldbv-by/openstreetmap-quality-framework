...
class DE_00001_A_a_003 extends DatabaseIntegrationTest {
    ...
    @Test
    void testInvalidIdentifikator() {
        // Arrange
        Map<String, String> tags = new HashMap<>();
        tags.put("identifikator:UUID", "123456789");
        tags.put("identifikator:UUIDundZeit", "DEBYBDLMCI0001qd_2021-03-12T11:48:42Z");
        tags.put("lebenszeitintervall:beginnt", "2021-03-12T11:48:42Z");
        tags.put("modellart:advStandardModell", "Basis-DLM"); // Todo: modellart muss eine Relation sein
        tags.put("modellart:sonstigesModell", "DTK10A"); // Todo: modellart muss eine Relation sein
        ...
        assertThat(result).as("QualityServiceResult must not be null").isNotNull();
        assertThat(result.isValid()).withFailMessage("Expected the result to be invalid because 'identifikator:UUID' has wrong format, but it was valid.").isFalse();
        ...
        assertThat(result.errors())
                ...
                .containsExactly("Das Tag identifikator:UUID dem regulären Ausdruck (^DE(BW|BU|BY|ST|SL|SH|NI|BE|BB|NW|RP|HE|MV|SN|HH|HB|TH)[A-Za-z0-9]{12})|(^DEBKG[A-Za-z0-9]{11})|(^DE_[A-Za-z0-9]{13}$) entsprechen.");
