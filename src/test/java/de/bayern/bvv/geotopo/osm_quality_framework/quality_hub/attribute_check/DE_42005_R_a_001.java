...
/**
 * AdV-Beschreibung:
 * Es ist zu prüfen, ob die Relation istTeilVon bei AX_Fahrbahnachse vorhanden ist
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_42005_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.42005.R.a.001"));
    ...
    @Test
    void createFahrbahnachseAufStrasse() throws Exception {
        // Arrange
    ...
    @Test
    void createFahrbahnachseOhneStrasse() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Die Objektart 'AX_Fahrbahnachse' erwartet mindestens 1 Relation/en 'AX_Strasse'.");
    }
}