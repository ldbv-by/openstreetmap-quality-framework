...
/**
 * AdV-Beschreibung:
 * Es ist zu prüfen, ob die Relation istTeilVon bei AX_Ast vorhanden ist
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_56004_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.56004.R.a.001"));
    ...
    @Test
    void createAstMitNetzknoten() throws Exception {
        // Arrange
    ...
    @Test
    void createAstOhneNetzknoten() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                    <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Die Objektart 'AX_Ast' erwartet mindestens 1 Relation/en 'AX_Netzknoten'.");
    }
}