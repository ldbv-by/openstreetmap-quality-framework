...
class DE_53001_B_c_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.53001.B.c.001"));
    ...
    @Test
    void createDurchfahrtMitGueltigerHoehe() throws Exception {
        // Arrange
    ...
    @Test
    void createDurchfahrtOhneHoehe() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
    ...
    @Test
    void createDurchfahrtMitUngueltigerHoehe() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
