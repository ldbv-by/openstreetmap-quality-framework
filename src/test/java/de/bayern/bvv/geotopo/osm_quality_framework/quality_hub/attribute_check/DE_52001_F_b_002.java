...
class DE_52001_F_b_002 extends DatabaseIntegrationTest {
    ...
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.52001.F.b.002"));
    ...
    @Test
    void createOrtslageMitNamen() throws Exception {
        // Arrange
    ...
    @Test
    void createOrtslageOhneName() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                    <create>
