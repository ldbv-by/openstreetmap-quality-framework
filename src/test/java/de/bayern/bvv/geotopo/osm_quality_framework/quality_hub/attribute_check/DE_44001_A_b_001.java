...
class DE_44001_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44001.A.b.001"));
    ...
    @Test
    void createKanalMitZustand() throws Exception {
        // Arrange
    ...
    @Test
    void createFliessgewaesserMitZustand() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'zustand' darf nur bei der 'funktion' 8300 vorkommen.");
    }
}