...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Objekthöhe' kann nur in Verbindung mit der
 * Attributart 'Art' und der Werteart 1620 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_55001_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.55001.A.b.001"));
    ...
    @Test
    void createWasserfallMitObjekthoehe() throws Exception {
        // Arrange
    ...
    @Test
    void createQuelleMitObjekthoehe() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'objekthoehe' darf nur bei der 'art' 1620 vorkommen.");
    }

    @Test
    void createQuelleOhneObjekthoehe() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
