...
class DE_44006_A_b_002 extends DatabaseIntegrationTest {
    ...
    @Test
    void createBaggerseeMitNutzung() throws Exception {
        // Arrange
    ...
    @Test
    void createStehendesGewaesserMitNutzung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'nutzung' darf nur bei der 'funktion' 8630, 8631 und 8640 vorkommen.");
    }
}