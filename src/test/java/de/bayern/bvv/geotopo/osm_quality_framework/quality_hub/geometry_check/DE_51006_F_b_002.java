...
/**
 * AdV-Beschreibung:
 * Die Wertearten 1440-1442 der Attributart 'Bauwerksfunktion' überlagern immer ein Objekt 41007 'FlächeBesondererFunktionalerPrägung'
 * oder 41008 'SportFreizeitUndErholungsfläche' mit 'Funktion' 4100 'Sportanlage'.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_51006_F_b_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51006.F.b.002"));
    ...
    @Test
    void createStadionAufSportFreizeitUndErholung() throws Exception {
        // Arrange
    ...
    @Test
    void createStadionAufSportFreizeitUndErholungOhneFunktion() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Die Wertearten mit der 'bauwerksfunktion' 1440 bis 1442 müssen 'AX_FlaecheBesondererFunktionalerPraegung' oder 'AX_SportFreizeitUndErholungsflaeche' mit 'funktion' 4100 überlagern.");
    }

    @Test
    void createStadionOhneSportFreizeitUndErholung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
