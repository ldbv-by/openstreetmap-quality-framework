 ...
 * Attributart 'Bauwerksfunktion' und der Werteart 1781 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_51009_A_b_005 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51009.A.b.005"));
    ...
    @Test
    void createBrunnenMitTrinkwasserversorgungUndBezeichnung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                ...
                <create>
                  <node id='-25402' changeset='-1' lat='49.88567721142' lon='12.33907207933'>
                    ...
                    <tag k='bauwerksfunktion' v='1781' />
                    <tag k='bezeichnung' v='Trinkwasserversorgung' />
                  </node>
                </create>
                </osmChange>
                """;
    ...
    @Test
    void createMauerMitBezeichnung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  ...
                  <way id='-665' changeset='-1'>
                    ...
                    <tag k='bezeichnung' v='Test Mauer' />
                  </way>
                </create>
                </osmChange>
                """;
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'bezeichnung' darf nur bei der 'bauwerksfunktion' 1781 vorkommen.");
    }
}