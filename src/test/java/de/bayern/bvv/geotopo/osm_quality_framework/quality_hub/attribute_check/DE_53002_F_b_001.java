...
/**
 * AdV-Beschreibung:
 * Wenn bei der Attributart 'Art' die Werteart 3001 'Kreuz', 3002 'Dreieck' oder 3003 'Anschlussstelle,
 * Anschluss' belegt ist, muss auch die Attributart 'Name' belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_53002_F_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.53002.F.b.001"));
    ...
    @Test
    void createKreuzMitName() throws Exception {
        // Arrange
    ...
    @Test
    void createKreuzOhneName() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'name' muss belegt sein, wenn die 'art' 3001, 3002 oder 3003 ist.");
    }
}