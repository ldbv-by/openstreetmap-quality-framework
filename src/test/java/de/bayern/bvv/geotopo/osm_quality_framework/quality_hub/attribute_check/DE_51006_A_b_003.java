 ...
 * Attributart 'Bauwerksfunktion' und den Wertearten 1420,1470 und 1490 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_51006_A_b_003 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51006.A.b.003"));
    ...
    @Test
    void createLaufbahnMitBreiteDesObjekts() throws Exception {
        // Arrange
    ...
    @Test
    void createZuschauertribueneMitBreite() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'breiteDesObjekts' darf nur bei der 'bauwerksfunktion' 1420, 1470 und 1490 vorkommen.");
    }
}