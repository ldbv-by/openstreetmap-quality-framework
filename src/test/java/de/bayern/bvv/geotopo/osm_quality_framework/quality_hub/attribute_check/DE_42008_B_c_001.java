...
class DE_42008_B_c_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.42008.B.c.001"));
    ...
    @Test
    void createFahrwegachseMitMindestBreitenklasse() throws Exception {
        // Arrange
    ...
    @Test
    void createFahrwegachseMitGueltigerBreitenklasse() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
    ...
    @Test
    void createFahrwegachseMitUngueltigerBreitenklasse() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
