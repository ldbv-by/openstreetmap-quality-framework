...
class DE_41002_A_b_001_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.41002.A.b.001_002"));
    ...
    @Test
    void createFoerderanlageMitfoerdergut() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                ...
                <create>
                  ...
                  <way id='-663' changeset='-1'>
                    ...
                    <tag k='funktion' v='2700' />
                    <tag k='foerdergut' v='1000' />
                  </way>
                </create>
                </osmChange>
                """;
    ...
    @Test
    void createBeherbergungMitFoerdergut() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'foerdergut' darf nur bei der 'funktion' 2510 und 2700 vorkommen.");
    }
}