...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Straßenschlüssel' kann nur in Verbindung mit der
 * Attributart 'Art' und der Werteart 4000 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_53002_A_b_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.53002.A.b.002"));
    ...
    @Test
    void createPlatzMitStrassenschluessel() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                ...
                <create>
                  <node id='-25402' changeset='-1' lat='49.88567721142' lon='12.33907207933'>
                    ...
                    <tag k='art' v='4000' />
                    <tag k='strassenschluessel' v='1234' />
                  </node>
                </create>
                </osmChange>
                """;
    ...
    @Test
    void createFurtMitStrassenschluessel() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'strassenschluessel' darf nur bei der 'art' 4000 vorkommen.");
    }
}