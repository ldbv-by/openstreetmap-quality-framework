...
class DE_51004_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51004.A.b.001"));
    ...
    @Test
    void createPipelineMitProduktErdoel() throws Exception {
        // Arrange
    ...
    @Test
    void createFoerderbandMitProduktErdoel() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'produkt' darf nur bei der 'bauwerksfunktion' 1101 und 1103 vorkommen.");
    }
}