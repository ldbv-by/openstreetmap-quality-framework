...
/**
 * AdV-Beschreibung:
 * Attributart 'Ergebnis der Überprüfung' nur bei Funktion 3001, 3003, 3004.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_61003_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.61003.A.b.001"));
    ...
    @Test
    void createDammMitHochwasserschutzUndErgebnisDerUeberpruefung() throws Exception {
        // Arrange
    ...
    @Test
    void createDammMitVerkehrsfuehrungUndErgebnisDerUeberpruefung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'ergebnisDerUeberpruefung' darf nur bei der 'funktion' 3001, 3003 und 3004 vorkommen.");
    }
}