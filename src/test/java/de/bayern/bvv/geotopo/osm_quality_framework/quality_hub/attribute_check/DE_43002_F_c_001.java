...
class DE_43002_F_c_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of());
    ...
    @Test
    void createWaldMitErlaubtenVegetationsmerkmal() throws Exception {
        // Arrange
    ...
    @Test
    void createWaldMitNichtErlaubtenVegetationsmerkmal() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  ...
                  <way id='-663' changeset='-1'>
                    ...
                    <nd ref='-25358' />
                    <tag k='object_type' v='AX_Wald' />
                    <tag k='vegetationsmerkmal' v='9999' />
                  </way>
                </create>
                </osmChange>
                """;
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'vegetationsmerkmal' hat einen ungültigen Wert.");
    }
}