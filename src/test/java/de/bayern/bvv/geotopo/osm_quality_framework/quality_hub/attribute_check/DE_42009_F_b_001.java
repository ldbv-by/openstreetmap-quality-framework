...
/**
 * AdV-Beschreibung:
 * Wenn bei der Attributart 'Funktion' die Werteart 5330 'Raststätte, Autohof' belegt ist, muss auch die Attributart 'Name' belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_42009_F_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.42009.F.b.001"));
    ...
    @Test
    void createAutohofMitName() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                ...
                <create>
                  ...
                  <way id='-663' changeset='-1'>
                    ...
                    <tag k='name:unverschluesselt' v='Autohof' />
    ...
    @Test
    void createAutohofOhneName() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Beim Objekt 'AX_Platz' mit 'funktion' 5330 muss das komplexe Tag 'name' belegt sein.");
    }
}