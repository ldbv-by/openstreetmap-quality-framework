...
/**
 * AdV-Beschreibung:
 * Flächenförmige Objekte aus dem Objektartenbereich "Tatsächliche Nutzung"
 * mit dem Attribut istWeitereNutzung (IWN) müssen untereinander überschneidungsfrei sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_40000_G_a_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.40000.G.a.002"));
    ...
    @Test
    void createWohnbauflaechenMitIstWeitererNutzungUeberschneidungsfrei() throws Exception {
        // Arrange
    ...
    @Test
    void createWohnbauflaechenMitIstWeitererNutzungNichtUeberschneidungsfrei() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Im Bereich der Objekte \"Tatsächliche Nutzung\" dürfen sich Flächen mit istWeitererNutzung nicht überschneiden.");
    }
}