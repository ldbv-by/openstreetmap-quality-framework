...
/**
 * AdV-Beschreibung:
 * Ist die Attributart 'istWeitereNutzung' belegt, so überlagert das Objekt immer ein Objekt der Objektart 41001, 44001 oder 44006.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_41001_F_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.41001.F.b.001"));
    ...
    @Test
    void createWohnbauflaecheMitIstWeitererNutzungAufWohnbauflaeche() throws Exception {
        // Arrange
    ...
    @Test
    void createWohnbauflaecheMitIstWeitererNutzungOhneWohnbauflaeche() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Das Objekt 'AX_Wohnbauflaeche' mit 'istWeitereNutzung' muss ein Objekt 'AX_Wohnbauflaeche', 'AX_Fliessgewaesser' ohne 'funktion' oder mit 'funktion' 8300 oder 'AX_StehendesGewaesser' ohne 'funktion' überlagern.");
    }
}
