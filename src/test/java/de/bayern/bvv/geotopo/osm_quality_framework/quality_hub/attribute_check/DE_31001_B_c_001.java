...
/**
 * AdV-Beschreibung:
 * Der Wert von 'Weitere Gebäudefunktion' darf nicht identisch mit dem Wert von 'Gebäudefunktion' sein
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_31001_B_c_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.31001.B.c.001"));
    ...
    @Test
    void createGebaeudeMitUnterschiedlicherGebaeudefunktion() throws Exception {
        // Arrange
    ...
    @Test
    void createGebaeudeMitGleicherGebaeudefunktion() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  <node id='-25402' changeset='-1' lat='49.88567721142' lon='12.33907207933'>
                    <tag k='gebaeudefunktion' v='2030' />
                    <tag k='weitereGebaeudefunktion' v='1000' />
                    <tag k='object_type' v='AX_Gebaeude' />
                  </node>
                </create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Der Wert von 'weitereGebaeudefunktion' darf nicht identisch mit dem Wert von 'gebaeudefunktion' sein.");
    }
}