...
/**
 * AdV-Beschreibung:
 * Ist das Attribut 'Ergebnis der Überprüfung' (EDU) belegt,
 * so muss auch das Attribut 'Datum der Überprüfung' (DLU) belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_40001_A_a_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.40001.A.a.002"));
    ...
    @Test
    void createWohnbauflaecheMitEDUundDLU() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                ...
                <create>
                  ...
                  <way id='-663' changeset='-1'>
                    ...
                    <tag k='ergebnisDerUeberpruefung' v='1000' />
                    <tag k='datumDerLetztenUeberpruefung' v='2025-10-14T12:53:00Z' />
    ...
    @Test
    void createWohnbauflaecheMitEDUohneDLU() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'datumDerLetztenUeberpruefung' muss belegt sein, sobald 'ergebnisDerUeberpruefung' belegt ist.");
    }
}