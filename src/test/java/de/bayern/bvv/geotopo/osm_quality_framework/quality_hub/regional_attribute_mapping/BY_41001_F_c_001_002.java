package de.bayern.bvv.geotopo.osm_quality_framework.quality_hub.regional_attribute_mapping;
...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Art der Bebauung' muss mit dem Wert 1000 oder 2000 belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
class BY_41001_F_c_001_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment", "regional-attribute-mapping"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.41001.F.c.001_002"));
    ...
    @Test
    void createWohnbauflaecheMitArtDerBebauung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                ...
                <create>
                  ...
                  <way id='-663' changeset='-1'>
                    ...
                    <tag k='by:dlm:artDerBebauung' v='10000' />
                  </way>
                </create>
                </osmChange>
                """;
    ...
    @Test
    void createWohnbauflaecheOhneArtDerBebauung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
