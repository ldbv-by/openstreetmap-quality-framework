...
class DE_43002_F_c_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.43002.F.c.002"));
    ...
    @Test
    void createWaldOhneZustandMitVegetationsmerkmal() throws Exception {
        // Arrange
    ...
    @Test
    void createWaldOhneZustandOhneVegetationsmerkmal() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
