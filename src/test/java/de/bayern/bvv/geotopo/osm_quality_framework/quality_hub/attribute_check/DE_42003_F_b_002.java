...
/**
 * AdV-Beschreibung:
 * Das Attribut 'Breite der Fahrbahn' muss belegt sein, wenn beim zugehörigen ZUSO 'Straße' das Attribut WDM mit dem
 * Wert 1301, 1303, 1305 oder 1306 belegt ist.
 * Ausnahme: Objekte, welche mit einem oder mehreren Objekten 'Fahrbahnachse' ein ZUSO 'Straße' bilden,
 * müssen von der Prüfung ausgeschlossen werden.
 */
@SpringBootTest
@AutoConfigureMockMvc
@Import(JacksonConfiguration.class)
class DE_42003_F_b_002 extends DatabaseIntegrationTest {
    ...
    @Test
    void createBundesautobahnMitBreiteDerFahrbahn() throws Exception {
        // Arrange
    ...
    @Test
    void createBundesautobahnOhneBreiteDerFahrbahn() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'breiteDerFahrbahn' muss belegt sein, wenn eine 'AX_Strassenachse' in einer Relation 'AX_Strasse' mit 'widmung' 1301, 1303, 1305 oder 1306 und ohne 'AX_Fahrbahnachse' liegt.");
    }

    @Test
    void createBundesautobahnMitFahrbahnachseOhneBreiteDerFahrbahn() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  ...
                  <way id='-1307' changeset='-1'>
                    <nd ref='-25363' />
                    <nd ref='-25364' />
                    <tag k='identifikator:UUID' v='DEBYBDLM12345671' />
                    <tag k='identifikator:UUIDundZeit' v='DEBYBDLM1234567120251014T125300Z' />
                    <tag k='lebenszeitintervall:beginnt' v='2025-10-14T12:53:00Z' />
