...
class DE_00001_A_a_004 extends DatabaseIntegrationTest {
    ...
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.00001.A.a.004"));
    ...
    @Test
    void createNichtVorhandenenIdentifikator() throws Exception {
        // Arrange
    ...
    @Test
    void createVorhandenenIdentifikator() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Der Objektidentifikator ist bereits vorhanden.");
    }
}