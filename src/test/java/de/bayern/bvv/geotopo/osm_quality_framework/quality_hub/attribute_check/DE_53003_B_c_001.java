...
class DE_53003_B_c_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.53003.B.c.001"));
    ...
    @Test
    void createWegPfadSteigMitGueltigerMindestBreitenklasse() throws Exception {
        // Arrange
    ...
    @Test
    void createWegPfadSteigMitGueltigerBreitenklasse() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  ...
                  <way id='-663' changeset='-1'>
                    ...
                    <nd ref='-25361' />
                    <tag k='object_type' v='AX_WegPfadSteig' />
                    <tag k='breiteDesVerkehrsweges' v='15' />
                  </way>
                </create>
                </osmChange>
                """;
    ...
    @Test
    void createWegPfadSteigMitUngueltigerBreitenklasse() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  ...
                  <way id='-663' changeset='-1'>
                    ...
                    <nd ref='-25361' />
                    <tag k='object_type' v='AX_WegPfadSteig' />
                    <tag k='breiteDesVerkehrsweges' v='5' />
                  </way>
                </create>
                </osmChange>
                """;
