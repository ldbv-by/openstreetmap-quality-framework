...
/**
 * AdV-Beschreibung:
 * Die Werteart 1470 der Attributart 'Bauwerksfunktion'
 * überlagert immer ein Objekt 41008 'SportFreizeitUndErholungsfläche' mit 'Funktion' 4100 'Sportanlage'.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_51006_G_b_006_F_b_007 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51006.G.b.006_F.b.007"));
    ...
    @Test
    void createSprungschanzeAufSportanlage() throws Exception {
        // Arrange
    ...
    @Test
    void createSprungschanzeOhneDarunterliegenderFlaeche() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Ein Objekt mit der 'bauwerksfunktion' 1470 muss ein Objekt 'AX_SportFreizeitUndErholungsflaeche' mit der 'funktion' 4100 überlagern.");
    }
}
