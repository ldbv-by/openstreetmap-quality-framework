...
class DE_51007_B_c_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51007.B.c.001"));
    ...
    @Test
    void createGrabMitGueltigerHoehe() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                ...
                <create>
                  <node id='-25402' changeset='-1' lat='49.88567721142' lon='12.33907207933'>
                    ...
                    <tag k='archaeologischerTyp' v='1000' />
                  </node>
    ...
    @Test
    void createGrabOhneHoehe() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
    ...
    @Test
    void createGrabMitUngueltigerHoehe() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
