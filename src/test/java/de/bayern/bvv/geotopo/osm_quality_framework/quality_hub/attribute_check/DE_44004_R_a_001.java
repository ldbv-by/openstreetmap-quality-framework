...
/**
 * AdV-Beschreibung:
 * Gewässerachse' ohne FKT ist Bestandteil des ZUSO 'Wasserlauf'.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_44004_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44004.R.a.001"));
    ...
    @Test
    void createGewaesserachseMitWasserlauf() throws Exception {
        // Arrange
    ...
    @Test
    void createGewaesserachseOhneWasserlauf() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Gewässerachse hat keine Relation zu Wasserlauf.");
    }
}