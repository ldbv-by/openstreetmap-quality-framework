...
/**
 * AdV-Beschreibung:
 * Ein Objekt aus dem Objektartenbereich "Tatsächliche Nutzung" darf keine Relation hatDirektUnten zu einem anderen Objekt
 * aus dem Objektartenbereich "Tatsächliche Nutzung" haben.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_40000_R_a_005 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.40000.R.a.005"));
    ...
    @Test
    void createWohnbauflaecheOhneHDU() throws Exception {
        // Arrange
    ...
    @Test
    void createWohnbauflaecheMitHDUAufHalde() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Ein Objekt aus dem Objektartenbereich \"Tatsächliche Nutzung\" darf keine Relation hatDirektUnten zu einem anderen Objekt aus dem Objektartenbereich \"Tatsächliche Nutzung\" haben.");
    }
}