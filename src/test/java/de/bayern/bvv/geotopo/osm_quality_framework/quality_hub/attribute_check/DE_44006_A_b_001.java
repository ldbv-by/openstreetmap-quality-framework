...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Bezeichnung' kann nur im Zusammenhang mit der
 * Attributart 'Funktion' und der Werteart 8640 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_44006_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44006.A.b.001"));
    ...
    @Test
    void createBaggerseeMitBezeichnung() throws Exception {
        // Arrange
    ...
    @Test
    void createStauseeMitBezeichnung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'bezeichnung' darf nur bei der 'funktion' 8640 vorkommen.");
    }
}