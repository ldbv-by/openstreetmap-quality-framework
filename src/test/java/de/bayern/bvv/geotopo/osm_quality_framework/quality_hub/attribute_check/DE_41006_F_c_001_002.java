...
class DE_41006_F_c_001_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.41006.F.c.001_002"));
    ...
    @Test
    void createFlaecheGemischterNutzungMitArtDerBebauung() throws Exception {
        // Arrange
    ...
    @Test
    void createFlaecheGemischterNutzungOhneArtDerBebauung() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
