...
/**
 * AdV-Beschreibung:
 * Es ist zu prüfen, ob die Relation istTeilVon bei AX_Fliessgewaesser  ohne FKT zu einem Objekt AX_Wasserlauf vorhanden ist
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_44001_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44001.R.a.001"));
    ...
    @Test
    void createFliessgewaesserMitWasserlauf() throws Exception {
        // Arrange
    ...
    @Test
    void createFliessgewaesserOhneWasserlauf() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Fließgewässer hat keine Relation zu Wasserlauf.");
    }
}