...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Lage zur Erdoberfläche' kann nur in Verbindung mit der
 * Attributart 'Bauwerksfunktion' und den Wertearten 1101 und 1102 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_51004_A_b_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51004.A.b.002"));
    ...
    @Test
    void createPipelineMitLageZurErdoberflaeche() throws Exception {
        // Arrange
    ...
    @Test
    void createPumpeMitLageZurErdoberflaeche() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'lageZurErdoberflaeche' darf nur bei der 'bauwerksfunktion' 1101 und 1102 vorkommen.");
    }
}