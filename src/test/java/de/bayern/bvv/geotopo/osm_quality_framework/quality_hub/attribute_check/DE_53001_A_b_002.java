...
class DE_53001_A_b_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.53001.A.b.002"));
    ...
    @Test
    void createDurchfahrtMitBreiteDesObjekts() throws Exception {
        // Arrange
    ...
    @Test
    void createBrueckeMitBreiteDesObjekts() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'breiteDesObjekts' darf nur bei der 'bauwerksfunktion' 1900 vorkommen.");
    }
}