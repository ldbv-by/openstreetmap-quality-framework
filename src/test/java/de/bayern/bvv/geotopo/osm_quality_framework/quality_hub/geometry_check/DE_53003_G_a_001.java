...
class DE_53003_G_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.53003.G.a.001"));
    ...
    @Test
    void createWegPfadSteigAsWay() throws Exception {
        // Arrange
    ...
    @Test
    void createWegPfadSteigAsArea() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Als Geometrietyp ist nur Liniengeometrie zugelassen.");
    }

    @Test
    void createWegPfadSteigAsNode() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
