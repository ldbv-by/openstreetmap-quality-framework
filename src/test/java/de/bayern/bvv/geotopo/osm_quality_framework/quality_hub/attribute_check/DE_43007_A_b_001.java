...
class DE_43007_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.43007.A.b.001"));
    ...
    @Test
    void createVegetationsloseFlaecheMitOberflaechenmaterial() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                ...
                <create>
                  ...
                  <way id='-663' changeset='-1'>
                    ...
                    <tag k='oberflaechenmaterial' v='1010' />
                  </way>
                </create>
                </osmChange>
                """;
    ...
    @Test
    void createGewaesserbegleitflaecheMitOberflaechenmaterial() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'oberflaechenmaterial' darf nur bei der 'funktion' 1000 vorkommen.");
    }
}