...
/**
 * AdV-Beschreibung:
 * Ist bei einem Objekt 43002 AX_Wald die Attributart 'Zustand' mit dem Wert 7100 'Dauerhaft unbestockt' belegt,
 * so darf die Attributart‚ Vegetationsmerkmal nicht mit einem Wert belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_43002_F_c_003 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.43002.F.c.003"));
    ...
    @Test
    void createWaldMitZustandDauerhaftUnbestocktOhneVegetationsmerkmal() throws Exception {
        // Arrange
    ...
    @Test
    void createWaldMitZustandDauerhaftUnbestocktMitVegetationsmerkmal() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
