...
/**
 * AdV-Beschreibung:
 * Es ist zu prüfen, ob die OID von AX_Kanal in der Relation istTeilVon bei AX_Gewaesserachse oder bei AX_Fliessgewaesser
 * bei AX_Gewaesserachse und AX_Fliessgewaesser vorhanden ist.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_44003_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44003.R.a.001"));
    ...
    @Test
    void createKanalMitFliessgewaesser() throws Exception {
        // Arrange
    ...
    @Test
    void createKanalOhneFliessgewaesser() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("'Kanal' besteht aus einem oder mehreren REO 'Fließgewässer' mit FKT 8300 oder einem oder mehreren REO 'Gewässerachse' mit FKT 8300 oder einem oder mehreren REO 'Fließgewässer' mit FKT 8300 und einem oder mehreren REO 'Gewässerachse' mit FKT 8300.");
    }
}