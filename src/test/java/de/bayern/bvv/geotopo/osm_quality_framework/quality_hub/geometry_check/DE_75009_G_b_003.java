...
/**
 * AdV-Beschreibung:
 * Lückenlose und überschneidungsfreie Flächendeckung der Objekte der Objektart 'Tatsächliche Nutzung' an der Landesgrenze.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_75009_G_b_003 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.75009.G.b.003"));
    ...
    @Test
    void createLandesgrenzeMitFlaechendeckenderTatsaechlichenNutzung() throws Exception {
        // Arrange
    ...
    @Test
    void createLandesgrenzeOhneFlaechendeckenderTatsaechlicherNutzung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("An der Landesgrenze muss eine lückenlose und überschneidungsfreie Flächendeckung Objekten der Objektart 'Tatsächliche Nutzung' bestehen.");
    }
}
