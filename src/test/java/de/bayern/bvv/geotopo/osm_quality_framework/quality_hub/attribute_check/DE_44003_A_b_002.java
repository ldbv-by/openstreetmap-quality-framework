...
/**
 * AdV-Beschreibung:
 * Es ist zu prüfen, dass die zu einem Kanal gehörenden Fließgewässer bzw. Gewässerachsen mit der Attributart Funktion (8300)
 * nur ohne die Attributart Hydrologisches Merkmal vorkommen können.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_44003_A_b_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44003.A.b.002"));
    ...
    @Test
    void createKanalMitGewaesserachseOhneHydrologischesMerkmal() throws Exception {
        // Arrange
    ...
    @Test
    void createKanalMitGewaesserachseMitHydrologischesMerkmal() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Die Relation 'AX_Kanal' darf auf den dazugehörenden 'AX_Fliessgewaesser' und 'AX_Gewaesserachse' mit 'funktion' 8300 das Tag 'hydrologischesMerkmal' nicht führen.");
    }
}