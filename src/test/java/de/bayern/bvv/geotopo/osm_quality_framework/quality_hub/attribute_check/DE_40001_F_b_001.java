...
/**
 * AdV-Beschreibung:
 * Die Attributart 'istWeitereNutzung' darf nur in Verbindung mit Objekten der Objektart
 * 41001, 41002, 41004, 41005, 41006, 41007, 41008, 41009, 42001, 42010, 42015 und 42016 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_40001_F_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.40001.F.b.001"));
    ...
    @Test
    void createWohnbauflaecheMitIstWeitererNutzung() throws Exception {
        // Arrange
    ...
    @Test
    void createHaldeMitIstWeitererNutzung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'istWeitereNutzung' darf nur in Verbindung mit Objekten der Objektart 41001, 41002, 41004, 41005, 41006, 41007, 41008, 41009, 42001, 42010, 42015 und 42016 vorkommen.");
    }
}