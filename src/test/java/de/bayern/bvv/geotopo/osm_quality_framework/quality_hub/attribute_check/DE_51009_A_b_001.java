...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Hydrologisches Merkmal' kann nur in Verbindung mit der
 * Attributart 'Bauwerksfunktion' und den Wertearten 1780 und 1781 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_51009_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51009.A.b.001"));
    ...
    @Test
    void createBrunnenMitHydrologischenMerkmal() throws Exception {
        // Arrange
    ...
    @Test
    void createTreppeMitHydrologischenMerkmal() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'hydrologischesMerkmal' darf nur bei der 'bauwerksfunktion' 1780 und 1781 vorkommen.");
    }
}