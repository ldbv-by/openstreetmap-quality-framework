...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Funktion' kann nur in Verbindung mit der
 * Attributart 'Art der Festlegung' und der Werteart 1510 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_71005_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.71005.A.b.001"));
    ...
    @Test
    void createWasserschutzgebietMitFunktion() throws Exception {
        // Arrange
    ...
    @Test
    void createHeilquellenschutzgebietMitFunktion() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'funktion' darf nur bei der 'artDerFestlegung' 1510 vorkommen.");
    }
}