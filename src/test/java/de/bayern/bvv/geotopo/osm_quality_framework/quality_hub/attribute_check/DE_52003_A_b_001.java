...
/**
 * AdV-Beschreibung:
 * Die Attributart 'KonstruktionsmerkmalBauart' muss mit dem Wert 1010 oder 1020 belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_52003_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.52003.A.b.001"));
    ...
    @Test
    void createSchleuseMitVorhandenenKonstruktionsmerkmal() throws Exception {
        // Arrange
    ...
    @Test
    void createSchleuseMitNichtVorhandenenKonstruktionsmerkmal() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'konstruktionsmerkmalBauart' hat einen ungültigen Wert.");
    }
}