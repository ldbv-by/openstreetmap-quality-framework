...
class DE_44005_F_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44005.F.b.001"));
    ...
    @Test
    void createHafenbeckenInHafen() throws Exception {
        // Arrange
    ...
    @Test
    void createHafenbeckenOhneHafen() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Ein Objekt 'AX_Hafenbecken' wird immer von 'AX_Hafen' überlagert.");
    }
}
