...
/**
 * AdV-Beschreibung:
 * Ist bei einem Objekt der Objektart 42015 'Flugverkehr' die Attributart 'istWeitereNutzung' belegt, so überlagert das
 * Objekt immer ein Objekt der Objektart 42015 'Flugverkehr', 44006 'Stehendes Gewässer' ohne FKT,
 * 44006 'Stehendes Gewässer' mit FKT 8630 'Stausee', 44006 'Stehendes Gewässer' mit FKT 8631 'Speicherbecken' oder 44007 'Meer'.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_42015_F_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.42015.F.b.001"));
    ...
    @Test
    void createFlugverkehrMitIstWeitererNutzungAufFlugverkehr() throws Exception {
        // Arrange
    ...
    @Test
    void createFlugverkehrMitIstWeitererNutzungOhneFlugverkehr() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Das Objekt 'AX_Flugverkehr' mit 'istWeitereNutzung' muss ein Objekt 'AX_Flugverkehr', 'AX_Meer' oder 'AX_StehendesGewaesser' ohne 'funktion' oder mit 'funktion' 8630 oder 8631 überlagern.");
    }
}
