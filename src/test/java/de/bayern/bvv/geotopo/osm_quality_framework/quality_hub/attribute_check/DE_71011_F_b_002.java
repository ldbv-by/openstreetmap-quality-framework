...
/**
 * AdV-Beschreibung:
 * Wenn bei der Attributart 'ADF' die Werteart 4720 belegt ist, muss auch die Attributart 'Name' belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_71011_F_b_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.71011.F.b.002"));
    ...
    @Test
    void createTruppenuebungsplatzMitName() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                ...
                <create>
                  ...
                  <way id='-663' changeset='-1'>
                    ...
                    <tag k='name' v='Truppenuebungsplatz' />
    ...
    @Test
    void createTruppenuebungsplatzOhneName() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'name' muss belegt sein, wenn 'artDerFestlegung' 4720 ist.");
    }
}