...
/**
 * AdV-Beschreibung:
 * Das ZUSO 'Wasserlauf' besteht aus einem oder mehreren REO 'Fließgewässer' oder einem oder mehreren REO 'Gewässerachse' oder
 * einem oder mehreren REO 'Fließgewässer' und einem oder mehreren REO 'Gewässerachse'.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_44002_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44002.R.a.001"));
    ...
    @Test
    void createWasserlaufMitFliessgewaesser() throws Exception {
        // Arrange
    ...
    @Test
    void createWasserlaufOhneFliessgewaesser() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das 'Wasserlauf' besteht aus einem oder mehreren REO 'Fließgewässer' oder einem oder mehreren REO 'Gewässerachse' oder einem oder mehreren REO 'Fließgewässer' und einem oder mehreren REO 'Gewässerachse'.");
    }
}