...
/**
 * AdV-Beschreibung:
 * Wenn bei der Attributart 'ADF' die Werteart 1621 belegt ist,
 * muss auch die Attributart 'Name' belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
@Import(JacksonConfiguration.class)
class DE_71006_F_b_001 extends DatabaseIntegrationTest {
    ...
    @Test
    void createNaturschutzgebietMitName() throws Exception {
        // Arrange
    ...
    @Test
    void createNaturschutzgebietOhneName() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'name' muss belegt sein, wenn 'artDerFestlegung' 1621 ist.");
    }
}