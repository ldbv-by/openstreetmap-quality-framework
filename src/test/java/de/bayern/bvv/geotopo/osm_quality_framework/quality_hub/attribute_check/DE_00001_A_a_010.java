...
/**
 * AdV-Beschreibung:
 * Konsistenz von @gml:id und gml:identifier.
 * Prüfung auf Instanzebene:
 * substring-after(gml:identifier,'urn:adv:oid:') = substring(@gml:id,1,16)
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_00001_A_a_010 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.00001.A.a.010"));
    ...
    ObjectMapper objectMapper = JsonMapper.builder()
            ...
            .build();
    @Test
    void createObjektMitKorrekterIdentifikatorKombination() throws Exception {
        // Arrange
    ...
    @Test
    void createObjektMitNichtKorrekterIdentifikatorKombination() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  <node id='-25402' changeset='-1' lat='49.88567721142' lon='12.33907207933'>
                    <tag k='identifikator:UUID' v='DEBYBDLM12345678' />
                    <tag k='identifikator:UUIDundZeit' v='DEBYBDLM1234123420251014T125300Z' />
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'identifikator:UUIDundZeit' muss mit 'identifikator:UUID' beginnen.");
    }
}