...
class DE_75012_G_b_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.75012.G.b.002"));
    ...
    @Test
    void createKommunalesTeilgebietDeckungsgleichMitGemeinde() throws Exception {
        // Arrange
    ...
    @Test
    void createKommunalesTeilgebietNichtDeckungsgleichMitGemeinde() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                    <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Kommunales Teilgebiet liegt nicht deckungsgleich auf Kommunalem Gebiet.");
    }
}
