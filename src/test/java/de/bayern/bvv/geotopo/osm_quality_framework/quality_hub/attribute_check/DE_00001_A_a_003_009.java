...
class DE_00001_A_a_003_009 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.00001.A.a.003_009"));
    ...
    @Test
    void createKorrektesFormatIdentifikator() throws Exception {
        // Arrange
    ...
    @Test
    void createNichtKorrektesFormatIdentifikator() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Der Objektidentifikator ist nicht GeoInfoDok-konform.");
    }
}