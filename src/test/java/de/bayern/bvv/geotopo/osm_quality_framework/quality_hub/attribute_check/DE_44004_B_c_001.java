...
/**
 * AdV-Beschreibung:
 * Die Breite der Gewaesserachse darf nur mit 3, 6 oder 12 belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
@Import(JacksonConfiguration.class)
class DE_44004_B_c_001 extends DatabaseIntegrationTest {
    ...
    @Test
    void createGewaesserachseMitMindestBreitenklasse() throws Exception {
        // Arrange
    ...
    @Test
    void createGewaesserachseMitGueltigerBreitenklasse() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
    ...
    @Test
    void createGewaesserachseMitUngueltigerBreitenklasse() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  ...
                  <way id='-1308' changeset='-1'>
                    ...
                    <tag k='fliessrichtung' v='TRUE' />
                    <tag k='zustand' v='4000' />
                    <tag k='breiteDesGewaessers' v='18' />
                  </way>
                  <relation id='-81' changeset='-1'>
                    <member type='way' ref='-1308' role='' />
                    <tag k='advStandardModell' v='Basis-DLM' />
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Attribut 'breiteDesGewaessers' muss immer mit dem Klassenwert 6, 9 oder 12 belegt sein.");
    }
}