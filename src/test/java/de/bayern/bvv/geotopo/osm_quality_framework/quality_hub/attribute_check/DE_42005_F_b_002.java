...
/**
 * AdV-Beschreibung:
 * Das Attribut 'Breite der Fahrbahn' muss belegt sein, wenn beim zugehörigen ZUSO 'Straße'
 * das Attribut WDM mit dem Wert 1301, 1303, 1305 oder 1306 belegt ist.
 */
@SpringBootTest
@AutoConfigureMockMvc
@Import(JacksonConfiguration.class)
class DE_42005_F_b_002 extends DatabaseIntegrationTest {
    ...
    void createBundesautobahnOhneBreiteDerFahrbahn() throws Exception {
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Bei einem Objekt 'AX_Fahrbahnachse' muss das Tag 'breiteDerFahrbahn' belegt sein, wenn diese in einer Relation 'AX_Strasse' mit 'widmung' 1301, 1303, 1305 oder 1306 liegt.");
    }
}