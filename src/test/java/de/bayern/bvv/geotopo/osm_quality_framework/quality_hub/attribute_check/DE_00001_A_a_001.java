...
class DE_00001_A_a_001 extends DatabaseIntegrationTest {
    ...
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.00001.A.a.001"));
    ...
    @Test
    void createKorrektesFormatLebenszeitintervallBeginnt() throws Exception {
        // Arrange
    ...
    @Test
    void createKorrektesFormatLebenszeitintervallBeginntBeiObjektnummernvergabe() throws Exception {
        // Arrange
        stepsToValidate.add("object-number-assignment");
    ...
    @Test
    void createNichtKorrektesFormatLebenszeitintervallBeginnt() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  <node id='-1' changeset='-1' lat='49.88567721142' lon='12.33907207933'>
                    <tag k='identifikator:UUID' v='DEBYBDLM12345678' />
                    <tag k='identifikator:UUIDundZeit' v='DEBYBDLM1234567820251014T125300Z' />
                    <tag k='lebenszeitintervall:beginnt' v='2025-10-14' />
                    <tag k='object_type' v='AX_Turm' />
                    <tag k='bauwerksfunktion' v='1003' />
                  </node>
                  <relation id='-1' changeset='-1'>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Die Zeitangabe ist nicht GeoInfoDok-konform.");
    }

    @Test
    void createNichtKorrektesFormatLebenszeitintervallEndet() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  <node id='-1' changeset='-1' lat='49.88567721142' lon='12.33907207933'>
                    ...
                    <tag k='lebenszeitintervall:beginnt' v='2025-10-14T12:53:00Z' />
                    <tag k='lebenszeitintervall:endet' v='2025-10-15' />
                    <tag k='object_type' v='AX_Turm' />
                    <tag k='bauwerksfunktion' v='1003' />
                  </node>
                  <relation id='-1' changeset='-1'>
