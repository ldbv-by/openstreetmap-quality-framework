...
class DE_00001_A_a_001 extends DatabaseIntegrationTest {
    ...
    @Test
    void createAxTurmWithValidTags() throws Exception {
        // Arrange
    ...
    @Test
    void createAxTurmWithInvalidFormatLebenszeitBeginnt() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
    ...
    @Test
    void createAxTurmWithInvalidFormatLebenszeitEndet() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
