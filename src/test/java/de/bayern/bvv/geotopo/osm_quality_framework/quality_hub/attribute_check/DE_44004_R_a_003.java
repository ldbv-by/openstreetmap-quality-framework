...
/**
 * AdV-Beschreibung:
 * Gewässerachse' mit FKT 8300 ist Bestandteil von ZUSO 'Kanal'
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_44004_R_a_003 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44004.R.a.003"));
    ...
    @Test
    void createGewaesserachseMitKanal() throws Exception {
        // Arrange
    ...
    @Test
    void createGewaesserachseOhneKanal() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Gewässerachse hat keine Relation zu Kanal.");
    }
}