...
class DE_56002_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.56002.R.a.001"));
    ...
    @Test
    void createNullpunktMitNetzknoten() throws Exception {
        // Arrange
    ...
    @Test
    void createNullpunktOhneNetzknoten() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                    <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Die Objektart 'AX_Nullpunkt' erwartet mindestens 1 Relation/en 'AX_Netzknoten'.");
    }
}