...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Zustand' mit der Werteart 2200 kann nur im Zusammenhang mit der
 * Attributart 'Bauwerksfunktion' und den Wertearten 1310 und 1320 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_51002_A_b_003 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51002.A.b.003"));
    ...
    @Test
    void createSchachtoeffnungMitZustandVerfallen() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                ...
                <create>
                  <node id='-25402' changeset='-1' lat='49.88567721142' lon='12.33907207933'>
                    ...
                    <tag k='bauwerksfunktion' v='1320' />
                    <tag k='zustand' v='2200' />
                  </node>
                </create>
                </osmChange>
                """;
    ...
    @Test
    void createFunkmastMitZustandVerfallen() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'zustand' mit der Werteart 2200 darf nur bei der 'bauwerksfunktion' 1310 und 1320 vorkommen.");
    }
}