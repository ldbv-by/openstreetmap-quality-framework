...
class DE_75012_A_b_002 extends DatabaseIntegrationTest {
    ...
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.75012.A.b.002"));
    ...
    void createGemeindeteilOhneGemeindeteil() throws Exception {
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'kennzeichen:gemeindeteil' muss in 'AX_KommunalesTeilgebiet' vorhanden sein.");
    }
}