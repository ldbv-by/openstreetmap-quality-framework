...
/**
 * AdV-Beschreibung:
 * Es ist zu prüfen, ob die OID von AX_SchutzgebietNachWasserrecht in der Relation istTeilVon bei AX_Schutzzone vorhanden ist
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_71005_R_a_001 extends DatabaseIntegrationTest {
    ...
    @Test
    void createSchutzgebietNachWasserrechtMitSchutzzone() throws Exception {
        // Arrange
    ...
    @Test
    void createSchutzgebietNachWasserrechtOhneSchutzzone() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                	<create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Die Objektart 'AX_Wohnbauflaeche' darf keine Relation 'AX_SchutzgebietNachWasserrecht' haben.");
    }
}