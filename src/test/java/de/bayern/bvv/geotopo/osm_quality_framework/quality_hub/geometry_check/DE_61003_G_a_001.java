...
class DE_61003_G_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.61003.G.a.001"));
    ...
    @Test
    void createAxDammWallDeichAsNode() throws Exception {
        // Arrange
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Als Geometrietypen sind nur Linien- und Flächengeometrien zugelassen.");
    }

    @Test
    void createAxDammWallDeichAsArea() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
    ...
    @Test
    void createAxDammWallDeichAsWay() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
