...
/**
 * AdV-Beschreibung:
 * Der Schlüssel des Gemeindeteils muss einem Katalogobjekt AX_Gemeindeteil entsprechen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_75012_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.75012.A.b.001"));
    ...
    @Test
    void createGemeindeteilMitKorrektenKatalogeintrag() throws Exception {
        // Arrange
    ...
    @Test
    void createGemeindeteilMitUnterschiedlichenKatalogeintrag() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'kennzeichen' muss einen vorhandenen 'AX_Gemeindeteil' entsprechen.");
    }
}