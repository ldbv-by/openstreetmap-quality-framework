...
/**
 * AdV-Beschreibung:
 * Objekte mit der Attributart 'ART' 1640, 1650 und 1660 liegen immer innerhalb
 * von 44001 'Fließgewässer', 44005 'Hafenbecken' oder 44007 'Meer'.
 *
 * Objekte mit der Attributart 'ART' 1630, 1640, 1650, 1660 oder 1700 liegen immer innerhalb
 * von 44001 'Fließgewässer', 44005 'Hafenbecken', 44006 'StehendesGewaesser' und/oder 44007 'Meer'.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_55001_G_b_001_004 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.55001.G.b.001_004"));
    ...
    @Test
    void createSandbankAufHafenbecken() throws Exception {
        // Arrange
    ...
    @Test
    void createSandbankOhneHafenbecken() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Ein 'AX_Gewaessermerkmal' mit 'art' 1630, 1640, 1650, 1660 oder 1700 liegen innerhalb eines 'AX_Fliessgewaesser', 'AX_Hafenbecken', 'AX_StehendesGewaesser' oder 'AX_Meer'.");
    }
}
