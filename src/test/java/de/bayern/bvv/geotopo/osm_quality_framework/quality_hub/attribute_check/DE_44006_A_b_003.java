...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Zustand' kann nur im Zusammenhang mit der
 * Attributart 'Funktion' und den Wertearten 8630 'Stausee', 8631 'Speicherbecken' und 8640 'Baggersee' vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_44006_A_b_003 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44006.A.b.003"));
    ...
    @Test
    void createBaggerseeMitZustand() throws Exception {
        // Arrange
    ...
    @Test
    void createStehendesGewaesserMitZustand() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'zustand' darf nur bei der 'funktion' 8630, 8631 und 8640 vorkommen.");
    }
}