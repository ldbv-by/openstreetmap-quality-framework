...
/**
 * AdV-Beschreibung:
 * 57003 AX_Gewaesserstationierungsachse mit AGA=2000 muss mit ZUSO (AX_Wasserlauf/AX_Kanal)
 * des unterlegten AX_Fliessgewaesser die gleiche Gewässerkennzahl und den gleichen Namen besitzen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_57003_F_c_004 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.57003.F.c.004"));
    ...
    @Test
    void createGewaesserstationierungsachseMitGleichenNamenUndGewaesserkennzahl() throws Exception {
        // Arrange
    ...
    @Test
    void createGewaesserstationierungsachseMitUnterschiedlichenNamen() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Die Gewässerstationierungsachse hat abweichende GWK/NAM vom unterlegten ZUSO.");
    }

    @Test
    void createGewaesserstationierungsachseMitUnterschiedlicherGewaesserkennzahl() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                <create>
