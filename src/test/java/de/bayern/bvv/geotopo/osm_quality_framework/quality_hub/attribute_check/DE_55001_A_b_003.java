 ...
 * Attributart 'Art' und der Werteart 1610 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_55001_A_b_003 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.55001.A.b.003"));
    ...
    @Test
    void createQuelleMitHydrologischesMerkmal() throws Exception {
        // Arrange
    ...
    @Test
    void createWattMitHydrologischesMerkmal() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'hydrologischesMerkmal' darf nur bei der 'art' 1610 vorkommen.");
    }
}