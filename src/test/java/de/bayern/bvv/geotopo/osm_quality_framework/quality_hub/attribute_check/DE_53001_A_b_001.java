...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Durchfahrtshöhe' kann nur in Verbindung mit der
 * Attributart 'Bauwerksfunktion' und der Werteart 1900 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_53001_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.53001.A.b.001"));
    ...
    @Test
    void createBrueckeMitDurchfahrtshoehe() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'durchfahrtshoehe' darf nur bei der 'bauwerksfunktion' 1900 vorkommen.");
    }
}