...
/**
 * AdV-Beschreibung:
 * Wenn ein Objekt 44001 "Fließgewässer' die Werteart 8300 bei der Attributart 'Funktion' führt,
 * darf die Attributart 'Hydrologisches Merkmal' nicht belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_44001_A_b_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44001.A.b.002"));
