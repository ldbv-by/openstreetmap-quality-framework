...
class DE_53004_G_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.53004.G.a.001"));
    ...
    @Test
    void createBahnverkehrsanlageAsWay() throws Exception {
        // Arrange
