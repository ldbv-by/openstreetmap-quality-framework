...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Lagergut' kann nur in Verbindung mit der
 * Attributart 'Funktion' und der Werteart 1740 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_41002_A_b_005_006 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.41002.A.b.005_006"));
    ...
    @Test
    void createLagerflaecheMitLagergut() throws Exception {
        // Arrange
    ...
    @Test
    void createBeherbergungMitLagergut() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'lagergut' darf nur bei der 'funktion' 1740 vorkommen.");
    }
}