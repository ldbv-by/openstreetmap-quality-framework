...
/**
 * AdV-Beschreibung:
 * Die Werteart 1450 der Attributart 'Bauwerksfunktion' überlagert immer ein
 * Objekt 41007 'FlächeBesondererFunktionalerPrägung' oder
 * 41008 'SportFreizeitUndErholungsfläche' mit 'Funktion' 4100 'Sportanlage', 4200 Freizeitanlage, 4320 'Schwimmen'
 * oder 4330 'Campingplatz'.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_51006_G_b_003_F_b_003 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51006.G.b.003_F.b.003"));
    ...
    @Test
    void createSchwimmbeckenAufFreizeitanlage() throws Exception {
        // Arrange
    ...
    @Test
    void createSchwimmbeckenAufSafaripark() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Ein Objekt mit der 'bauwerksfunktion' 1450 muss ein Objekt 'AX_FlaecheBesondererFunktionalerPraegung' oder 'AX_SportFreizeitUndErholungsflaeche' mit der 'funktion' 4100, 4200, 4320 oder 4330 überlagern.");
    }

    @Test
    void createSchwimmbeckenOhneDarunterliegenderFlaeche() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
