 ...
 * 4170 'Tennis', oder 4320 'Schwimmen' (mit der Fachdatenverbindung art: 2600 und
 * name: 221430 LN_Sportanlage SPO1040 Schwimmen).
 */
@SpringBootTest
...
class DE_51006_G_b_002 extends DatabaseIntegrationTest {
    ...
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51006.G.b.002"));
    ...
    @Test
    void createStadionAufSchwimmenMitFachdatenverbindungLeistungsschwimmen() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  ...
                  <relation id='-100' changeset='-1'>
                    ...
                    <tag k='art' v='urn:abc:fdv:2600' />
                    <tag k='fachdatenobjekt:name' v='221430 LN_Sportanlage SPO1040 Schwimmen' />
                  </relation>
                </create>
                </osmChange>
                """;
    ...
    @Test
    void createStadionAufSchwimmenOhneFachdatenverbindungLeistungsschwimmen() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Ein Stadion darf sich nur auf Fläche besonderer funktionaler Prägung oder Sport-, Freizeit- und Erholungsfläche mit den Funktionen Sportanlage, Reitsport, Tennis, Schwimmen (mit FDV zum Leistungsschwimmen) befinden.");
    }
