...
class DE_00001_A_a_008 extends DatabaseIntegrationTest {
    ...
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.00001.A.a.008"));
    ...
    @Test
    void createKorrektesFormatIdentifikatorMitZeit() throws Exception {
        // Arrange
    ...
    @Test
    void createNichtKorrektesFormatIdentifikatorMitZeit() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
