...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Vegetationsmerkmal' muss mit dem Wert 1100, 1200 oder 1300 belegt sein.
 * Führt ein Objekt AX_Wald kein ZUS 7100, muss VEG mit 1100, 1200 oder 1300 belegt sein.
 * Führt ein Objekt AX_Wald den ZUS 7100, darf VEG nicht mit einem Wert belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
@Import(JacksonConfiguration.class)
class DE_43002_F_c_001_002_003 extends DatabaseIntegrationTest {
    ...
    @Test
    void createNeuanpflanzungsflaecheMitZustandDauerhaftUnbestocktOhneVegetationsmerkmal() throws Exception {
        // Arrange
    ...
    @Test
    void createNeuanpflanzungsflaecheMitZustandDauerhaftUnbestocktMitVegetationsmerkmal() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  ...
                  <way id='-663' changeset='-1'>
                    ...
                    <tag k='zustand' v='7100' />
                    <tag k='name' v='Waldbestattungsflaeche' />
                    <tag k='vegetationsmerkmal' v='1100' />
                  </way>
                  <relation id='-70' changeset='-1'>
                    <member type='way' ref='-663' role='' />
                    <tag k='advStandardModell' v='Basis-DLM' />
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Ein Objekt 'AX_Wald' mit 'zustand' 7100 darf kein Tag 'vegetationsmerkmal' haben.");
    }

    @Test
    void createNeuanpflanzungsflaecheOhneZustandDauerhaftUnbestocktMitVegetationsmerkmal() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
    ...
    @Test
    void createNeuanpflanzungsflaecheOhneZustandDauerhaftUnbestocktOhneVegetationsmerkmal() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
        ...
        assertThat(attributeCheck.errors())
                .extracting(QualityServiceErrorDto::errorText)
                .as("Error text of 'attribut-check'")
                .contains("Ein Objekt 'AX_Wald' ohne 'zustand' 7100 muss ein Tag 'vegetationsmerkmal' haben.");
    }
}