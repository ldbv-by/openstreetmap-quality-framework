...
/**
 * AdV-Beschreibung:
 * Es ist zu prüfen, ob die Relation istTeilVon bei AX_Nullpunkt vorhanden ist
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_73009_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.73009.R.a.001"));
    ...
    @Test
    void createVerwaltungsgemeinschaftMitZweiGemeinden() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                	<create>
                		...
                		<node id="-7" lon="12.328069199066023" lat="49.87778745354166" version="0"/>
                		<node id="-8" lon="12.3280773300033" lat="49.876828571667" version="0"/>
                		<way id="-1" version="0">
                			<nd ref="-1"/>
                			<nd ref="-2"/>
                			<nd ref="-3"/>
                		...
                		<relation id='-4' changeset='-1'>
                            ...
                            <tag k='istTeilVonVerwaltungsgemeinschaft:schluessel:regierungsbezirk' v='00' />
                            <tag k='istTeilVonVerwaltungsgemeinschaft:schluessel:verwaltungsgemeinschaft' v='00' />
                            <tag k='bezeichnung' v='Kastl' />
                            <tag k='schluesselGesamt' v='0000000000' />
                        </relation>
                        <relation id='-5' changeset='-1'>
                            <member type='relation' ref='-2' role='' />
                            <member type='relation' ref='-4' role='' />
                            <tag k='object_type' v='AX_Verwaltungsgemeinschaft' />
                            <tag k='schluessel:land' v='00' />
                            <tag k='schluessel:regierungsbezirk' v='00' />
                            <tag k='schluessel:kreis' v='00' />
                            <tag k='schluessel:verwaltungsgemeinschaft' v='00' />
                            <tag k='bezeichnung' v='Kemnath' />
                            <tag k='schluesselGesamt' v='0000000000' />
                        </relation>
                	</create>
    ...
    @Test
    void createVerwaltungsgemeinschaftMitEinerGemeinde() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                	<create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Eine 'Verwaltungsgemeinschaft' besteht aus mehreren NREO 'Gemeinde'.");
    }
}