 ...
 * Attributart 'Bauwerksfunktion' und der Werteart 1700 vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_51009_A_b_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.51009.A.b.002"));
    ...
    @Test
    void createMauerMitFunktion() throws Exception {
        // Arrange
    ...
    @Test
    void createBrunnenMitFunktion() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'funktion' darf nur bei der 'bauwerksfunktion' 1700 vorkommen.");
    }
}