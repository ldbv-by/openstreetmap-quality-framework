...
/**
 * AdV-Beschreibung:
 * Ist bei einem Objekt AX_Strasse IBD nicht belegt und die Widmung
 * mit dem Wert 1301 oder 1303 belegt, muss das Attribut BEZ belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
@Import(JacksonConfiguration.class)
class DE_42002_F_b_006 extends DatabaseIntegrationTest {
        ...
        final String CHANGESET_XML = """
                ...
                <create>
                  ...
                  <relation id='-77' changeset='-1'>
                    <member type='way' ref='-1308' role='' />
                    <tag k='bezeichnung' v='Bundesautobahn' />
    ...
    @Test
    void createBundesautobahnOhneBezeichnung() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'bezeichnung' muss bei 'widmung' 1301 oder 1303 und ohne 'internationaleBedeutung' belegt sein.");
    }
}