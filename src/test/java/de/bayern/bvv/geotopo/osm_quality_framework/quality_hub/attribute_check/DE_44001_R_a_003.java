...
/**
 * AdV-Beschreibung:
 * Es ist zu prüfen, ob bei einem AX_Fließgewaesser mit FKT 8300 Kanal  die Relation istTeilVon bei AX_Fliessgewaesser zu einem Objekt AX_Kanal vorhanden ist
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_44001_R_a_003 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44001.R.a.003"));
    ...
    @Test
    void createFliessgewaesserMitKanal() throws Exception {
        // Arrange
    ...
    @Test
    void createFliessgewaesserOhneKanal() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Fließgewässer hat keine Relation zu Kanal.");
    }
}