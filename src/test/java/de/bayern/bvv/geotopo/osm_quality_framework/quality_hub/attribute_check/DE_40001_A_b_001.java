...
/**
 * AdV-Beschreibung:
 * Die Werteart 1200 'Parken' der Attributart 'Funktion' kann nur in Verbindung mit der
 * Attributart 'istWeitereNutzung' vorkommen.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_40001_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.40001.A.b.001"));
    ...
    @Test
    void createWohnbauflaecheMitFunktionParkenUndIstWeitererNutzung() throws Exception {
        // Arrange
    ...
    @Test
    void createWohnbauflaecheMitFunktionParkenUndOhneIstWeitererNutzung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'istWeitereNutzung' muss belegt sein, sobald 'funktion' den Wert 1200 hat.");
    }
}