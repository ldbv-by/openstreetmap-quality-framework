...
class DE_56001_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.56001.R.a.001"));
    ...
    @Test
    void createNetzknotenMitEinemNullpunkt() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                    <create>
                        <node id="-1" lon="12.324354388416007" lat="49.87831289713437" version="0">
                            <tag k="object_type" v="AX_Nullpunkt"/>
                            <tag k="artDesNullpunktes" v="1000"/>
                            <tag k="bezeichnung" v="Test"/>
                        </node>
                        <relation id="-1" version="0">
                            <member type="node" role="" ref="-1"/>
                            <tag k="object_type" v="AX_Netzknoten"/>
                            <tag k="bezeichnung" v="Test"/>
                        </relation>
                    </create>
                    <modify/>
    ...
    @Test
    void createNetzknotenMitMehrerenNullpunkten() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                    <create>
                        ...
                        <node id="-2" lon="12.326848805302411" lat="49.878325604179174" version="0">
                            <tag k="object_type" v="AX_Nullpunkt"/>
                            <tag k="artDesNullpunktes" v="1000"/>
                            <tag k="bezeichnung" v="Test"/>
                        </node>
    ...
    @Test
    void createNetzknotenMitMehrerenNullpunktenUndEinemAst() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                    <create>
    ...
    @Test
    void createNetzknotenOhneNullpunkteUndEinemAst() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                    <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Ein Netzknoten besteht aus einem oder mehreren Nullpunkten und optional einem oder mehreren Ästen.");
    }
}