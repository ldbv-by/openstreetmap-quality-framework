...
class DE_41007_F_c_001_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.41007.F.c.001_002"));
    ...
    @Test
    void createFlaecheBesondererFunktionalerPraegungMitArtDerBebauung() throws Exception {
        // Arrange
    ...
    @Test
    void createFlaecheBesondererFunktionalerPraegungOhneArtDerBebauung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
