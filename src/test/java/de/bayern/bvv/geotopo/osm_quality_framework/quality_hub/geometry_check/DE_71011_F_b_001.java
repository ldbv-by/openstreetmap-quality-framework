...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Art der Festlegung' mit der Werteart 9450 'Hafenbecken' liegt immer innerhalb der Umrissgeometrie
 * von einem oder mehreren räumlich aneinandergrenzenden Objekten 52002 'Hafen' und 44001 'Fließgewässer'
 * oder 44006 'Stehendes Gewässer' oder 44007 'Meer'.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_71011_F_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.71011.F.b.001"));
    ...
    @Test
    void createHafenbeckenMitMeer() throws Exception {
        // Arrange
    ...
    @Test
    void createHafenbeckenOhneMeer() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Ein Objekt 'AX_SonstigesRecht' mit 'artDerFestlegung' 9450 liegt immer innerhalb von 'AX_Hafen', 'AX_Fliessgewaesser', 'AX_StehendesGewaesser' oder 'AX_Meer'.");
    }
}
