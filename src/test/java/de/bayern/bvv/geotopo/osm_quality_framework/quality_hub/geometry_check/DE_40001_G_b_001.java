...
/**
 * AdV-Beschreibung:
 * Objekte, die Unterklassen von AX_TatsaechlicheNutzung sind und sowohl die 'funktion' 1200 'Parken' haben
 * als auch das Attribut 'istWeitereNutzung', dürfen sich gegenseitig nicht überschneiden (DE-9IM: T********).
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_40001_G_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.40001.G.b.001"));
    ...
    @Test
    void createWohnbauflaechenMitFunktionParkenUndIstWeitereNutzungUeberschneidungsfrei() throws Exception {
        // Arrange
    ...
    @Test
    void createWohnbauflaechenMitFunktionParkenUndIstWeitereNutzungNichtUeberschneidungsfrei() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                <create>
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Im Bereich der Objekte \"Tatsächliche Nutzung\" dürfen sich Flächen mit der Funktion Parken und IstWeitereNutzung nicht überschneiden.");
    }
}