 ...
 * AX_Vegetationsmerkmal (54001) mit der 'Funktion' 1000, AX_Polder (55003)
 */
@SpringBootTest
...
class DE_50001_A_b_001 extends DatabaseIntegrationTest {
    ...
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.50001.A.b.001"));
    ...
    @Test
    void createErlaubtesBauwerkOderAnlageFuerSportFreizeitUndErholungOhneEDU() throws Exception {
        // Arrange
    ...
    @Test
    void createErlaubtesBauwerkOderAnlageFuerSportFreizeitUndErholungMitBauwerksfunktionMitEDU() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
    ...
    @Test
    void createNichtErlaubtesBauwerkOderAnlageFuerSportFreizeitUndErholungMitBauwerksfunktionMitEDU() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
    ...
    @Test
    void createErlaubtesBauwerkOderAnlageFuerSportFreizeitUndErholungMitSportartMitEDU() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
    ...
    @Test
    void createSonstigesBauwerkOderSonstigeEinrichtungMitEDU() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
    ...
    @Test
    void createSonstigesBauwerkOderSonstigeEinrichtungOhneFunktionMitEDU() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
