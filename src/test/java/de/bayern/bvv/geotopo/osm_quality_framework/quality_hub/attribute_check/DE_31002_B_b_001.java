...
/**
 * AdV-Beschreibung:
 * Diese Attributart 'durchfahrtshoehe' darf nur bei der Attributart 'Bauart' mit den Wertearten 2610 und 2620 geführt werden.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_31002_B_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.31002.B.b.001"));
    ...
    @Test
    void createDurchfahrtMitDurchfahrtshoehe() throws Exception {
        // Arrange
    ...
    @Test
    void createTiefgarageMitDurchfahrtshoehe() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'durchfahrtshoehe' darf nur bei der 'bauart' 2610 und 2620 geführt werden.");
    }
}