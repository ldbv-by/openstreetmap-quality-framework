...
class DE_53001_G_b_001 extends DatabaseIntegrationTest {
    ...
    void createBrueckeMitNichtKompletterBahnstrecke() throws Exception {
        ...
        assertThat(geometryCheck.errors())
                ...
                .contains("Bei linienförmiger Modellierung müssen die Geometrien der HDU Relations identisch sein. Bei flächenförmiger Modellierung müssen die 'over' in 'under' enthalten sein.");
    }
}
