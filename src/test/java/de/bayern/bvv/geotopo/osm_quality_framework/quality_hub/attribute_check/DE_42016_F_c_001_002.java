...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Funktion' muss mit dem Wert 5610 oder 5620 belegt sein.
 * Die Attributart 'Funktion' muss mit dem Wert 2342, 5610 oder 5620 belegt sein.
 */
@SpringBootTest
@AutoConfigureMockMvc
@Import(JacksonConfiguration.class)
class DE_42016_F_c_001_002 extends DatabaseIntegrationTest {
    ...
    @Test
    void createSchiffsverkehrMitFunktionHafenanlage() throws Exception {
        // Arrange
    ...
    @Test
    void createSchiffsverkehrMitFunktionBetriebsflaecheSchiffsverkehr() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'funktion' hat einen ungültigen Wert.");
    }
}