...
/**
 * AdV-Beschreibung:
 * Gemäß AX_Themendefinition und Topologiethema 'Strassenverkehrsachsen Basis-DLM' müssen Straßenverkehrsachsen (OA 42003, 42005, 42008, 57002)
 * jeweils über topologische Knoten verbunden sein und lösen damit an Kreuzungspunkten eine REO Bildung aus.
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_02000_G_a_022 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("geometry-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.02000.G.a.022"));
    ...
    @Test
    void createStrassennetzMitKorrekterReoBildung() throws Exception {
        // Arrange
    ...
    @Test
    void createStrassennetzMitFehlenderReoBildung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                    <create>
