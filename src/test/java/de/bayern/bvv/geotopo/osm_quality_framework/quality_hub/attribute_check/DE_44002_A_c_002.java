...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Widmung' wird nur belegt, wenn die Attributart 'Gewässerkennzahl' belegt ist und/oder wenn die zum
 * ZUSO 44002 'Wasserlauf' gehörenden REO 44004 'Gewässerachse' nicht die Attributart 'Hydrologisches Merkmal' führen
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_44002_A_c_002 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.44002.A.c.002"));
    ...
    @Test
    void createWasserlaufMitWidmungMitGewaesserkennzahl() throws Exception {
        // Arrange
    ...
    @Test
    void createWasserlaufMitWidmungOhneHydrologischesMerkmal() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                <create>
    ...
    @Test
    void createWasserlaufMitWidmungMitHydrologischesMerkmal() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="iD">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'widmung' wird nur belegt, wenn 'gewaesserkennzahl' belegt ist und/oder die zur Relation gehörenden 'AX_Gewaesserachse' nicht das Tag 'hydrologischesMerkmal' führen.");
    }
}