...
/**
 * AdV-Beschreibung:
 * Die Attributart 'Spurweite' mit der Werteart 9997 kann nur im Zusammenhang mit der
 * Attributart 'Bahnkategorie' und der Werteart 1600 vorkommen
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_42014_A_b_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.42014.A.b.001"));
    ...
    @Test
    void createMagnetschwebebahnMitSpurweiteAttributTrifftNichtZu() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                ...
                <create>
                  ...
                  <way id='-1308' changeset='-1'>
                    ...
                    <tag k='bahnkategorie' v='1600' />
                    <tag k='spurweite' v='9997' />
                    <tag k='elektrifizierung' v='1000' />
                    <tag k='anzahlDerStreckengleise' v='2000' />
                  </way>
                </create>
                </osmChange>
                """;
    ...
    @Test
    void createMagnetschwebebahnUndMuseumsbahnMitSpurweiteAttributTrifftNichtZu() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
                  ...
                  <way id='-1308' changeset='-1'>
                    ...
                    <nd ref='-25364' />
                    <tag k='object_type' v='AX_Bahnstrecke' />
                    <tag k='bahnkategorie' v='1400;1600' />
                    <tag k='spurweite' v='9997' />
                    <tag k='elektrifizierung' v='1000' />
                    <tag k='anzahlDerStreckengleise' v='2000' />
                  </way>
    ...
    @Test
    void createMuseumsbahnMitSpurweiteAttributTrifftNichtZu() throws Exception {
        // Arrange
        final Long CHANGESET_ID = 1L;
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'spurweite' mit dem Wert 9997 darf nur bei der 'bahnkategorie' 1600 vorkommen.");
    }
}