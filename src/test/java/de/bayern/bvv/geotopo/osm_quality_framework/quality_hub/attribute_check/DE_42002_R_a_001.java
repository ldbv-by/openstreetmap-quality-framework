...
/**
 * AdV-Beschreibung:
 * Es ist zu prüfen, ob die OID von Strasse in der Relation istTeilVon
 * bei AX_Strassenachse oder bei AX_Strassenachse und einem oder mehreren REO AX_Fahrbahnachse vorhanden ist
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_42002_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.42002.R.a.001"));
    ...
    @Test
    void createStrasseMitStrassenachseUndFahrbahnachse() throws Exception {
        // Arrange
    ...
    @Test
    void createStrasseMitStrassenachse() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
    ...
    @Test
    void createStrasseMitFahrbahnachse() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Eine 'Straße' besteht aus einem oder mehreren REO 'Straßenachse' oder einem oder mehreren REO 'Straßenachse' und einem oder mehreren REO 'Fahrbahnachse'.");
    }
}