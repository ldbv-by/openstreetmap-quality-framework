...
/**
 * AdV-Beschreibung:
 * Es ist zu prüfen, ob die Relation istTeilVon bei AX_Strukturlinie3D mit ART 1210 bis 1250 vorhanden ist
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_62030_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.62030.R.a.001"));
    ...
    @Test
    void createStrukturlinieMitBoeschungKliff() throws Exception {
        // Arrange
    ...
    @Test
    void createStrukturlinieOhneBoeschungKliff() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Strukturlinie 3D hat keine Relation zu Böschung, Kliff.");
    }
}