...
class DE_71012_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.71012.R.a.001"));
    ...
    @Test
    void createSchutzzoneMitSchutzgebiet() throws Exception {
        // Arrange
    ...
    @Test
    void createSchutzzoneOhneSchutzgebiet() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Schutzzone hat keine Relation zu SchutzgebietNachWasserrecht oder SchutzgebietNachNaturUmweltOderBodenschutzrecht.");
    }
}