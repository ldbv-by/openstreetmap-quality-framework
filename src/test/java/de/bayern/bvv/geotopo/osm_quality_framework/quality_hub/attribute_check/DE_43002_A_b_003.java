...
class DE_43002_A_b_003 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.43002.A.b.003"));
    ...
    @Test
    void createNeuanpflanzungsflaecheMitNutzung() throws Exception {
        // Arrange
    ...
    @Test
    void createNeuanpflanzungsflaecheOhneNutzung() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Das Tag 'zustand' kann nur in Verbindung mit dem Tag 'nutzung' vorkommen.");
    }
}