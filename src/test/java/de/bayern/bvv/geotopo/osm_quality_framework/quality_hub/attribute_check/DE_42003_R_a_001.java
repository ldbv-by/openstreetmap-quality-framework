...
/**
 * AdV-Beschreibung:
 * Es ist zu prüfen, ob die Relation istTeilVon bei AX_Strassenachse vorhanden ist
 */
@SpringBootTest
@AutoConfigureMockMvc
class DE_42003_R_a_001 extends DatabaseIntegrationTest {

    final Long CHANGESET_ID = 1L;

    Set<String> stepsToValidate = new HashSet<>(Set.of("attribute-check", "object-number-assignment"));
    Set<String> rulesToValidate = new HashSet<>(Set.of("DE.42003.R.a.001"));
    ...
    @Test
    void createStrassenachseAufStrasse() throws Exception {
        // Arrange
    ...
    @Test
    void createStrassenachseOhneStrasse() throws Exception {
        // Arrange
        final String CHANGESET_XML = """
                <osmChange version="0.6" generator="JOSM">
                <create>
        ...
        assertThat(attributeCheck.errors())
                ...
                .contains("Die Objektart 'AX_Strassenachse' erwartet mindestens 1 Relation/en 'AX_Strasse'.");
    }
}